...
<head>
  ...
  <link rel="stylesheet" href="HOSPITALS.CSS"></link>
...
<main>
    <div class="intro">
    <h1>AVAILABLITY OF HOSPITALS</h1>
   
    </div>
    <div class="achievements">
        <div class="work">
        <i class="fas fa-atom"></i>
        <p class="work-heading">TRANSPORT</p>
        <p class="work-text">24*7 AMBULANCE FACELITIES</p>
        </div>
        <div class="work">
        <i class="fas fa-skiing"></i>
        <p class="work-heading">COMMUNICATION</p>
        <p class="work-text">7 TO 10MINUTES DISTANCE OF RAILWAY STATION, BUS TRAINS ARE AVAILABLE</p>
        </div>
        <div class="work">
        ...
        <div class="about-me">
            <div class="about-me-text">
                ...
                <p>HOSPITALS ARE  OF WELL BEHAVIOURAL STAFS AND DECEPLINES MANNERS.</p>
                </div>
                <img src="H9.png" alt="me">
                </div>
               </main>
               <footer class="footer">
